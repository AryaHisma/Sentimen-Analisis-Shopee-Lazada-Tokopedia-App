...
def dashboard():
    ...
    st.markdown(''' 
                ...
                remove stopword. Untuk penjelasan lebih lanjut tentang preprocessing data dapat dilihat pada bagian analysis. 
                ...
                score : nilai bintang yang diberikan oleh pelanggan pengguna aplikasi, thumbsUpCount : jumlah pelanggan yang setuju dengan review 
                yang sudah dibuat, at : tanggal dan waktu review pelanggan pengguna
            ...
            with st.container(height=850, border=True):
                ...
                def Network_Analisis_Seluruh_Data_N_gram_4_kata_menjadi_2_kata_dengan_parameter(df, most_common, center_node, depth):
                    ...
                    if center_node in G.nodes():
                        ...
                        st.error(f"Node '{center_node}' tidak ditemukan dalam graf.")
                        return None
